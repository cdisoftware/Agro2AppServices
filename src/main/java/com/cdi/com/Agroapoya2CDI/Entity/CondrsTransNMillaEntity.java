...
@NamedStoredProcedureQueries({
    @NamedStoredProcedureQuery(
            name = "paC_conductoresTransportesNuevosMilla",
            procedureName = "paC_conductoresTransportesNuevosMilla",
            resultClasses = CondrsTransNMillaEntity.class)
})
public class CondrsTransNMillaEntity {

...
public class Controller {
    ...
    @Autowired
    clienteGeograficaService serviceclienteGeograficaService;

    @Autowired
    ConsUserLocalidadService serviceConsUserLocalidadService;

    @Autowired
    ConsUserLocalidadComprasService serviceConsUserLocalidadComprasService;

    @Autowired
    adPesoTotalLibraService serviceadPesoTotalLibraService;
    ...
    @Autowired
    EnvioSMSIndvAA2Service serviceEnvioSMSIndvAA2Service;

    @Autowired
    agroDescuentoModService serviceagroDescuentoModService;

    @Autowired
    agroDescuentoConsultaService serviceagroDescuentoConsultaService;

    @Autowired
    RelacionCuponesUsuarioService serviceRelacionCuponesUsuarioService;

    @Autowired
    BuscarXIdManychatService serviceBuscarXIdManychatService;
    ...
    //Consulta usuarios por idmanychat - ManyChat
    @PostMapping("/buscarIdManyChatInfo")
    public String ConsultarIdmanychatInfo(
            @RequestBody BuscarXIdManychatEntity entidad) {
        return serviceBuscarXIdManychatService.ConsultarIdmanychatInfo(entidad);
    }
    ...
    @PostMapping("/consAdListaPersona/{Bandera}/{Cd_tpo_usuario}/{Usucodig}/{TipoRegistro}/{RegistroValidado}")
    public List<adlistaPersonaEntity> consultaadlistaPersona(
            ...
            @PathVariable Integer RegistroValidado) {
        return serviceadlistaPersonaService.consultaadlistaPersona(entidad, Bandera, Cd_tpo_usuario, Usucodig, TipoRegistro, RegistroValidado);
    }
    ...
    @PostMapping("/modCClis/{Bandera}")
    public String ModCClis(
            @RequestBody CClisModEntity entidad,
            @PathVariable Integer Bandera) {
        return serviceCClisModService.ModCClis(entidad, Bandera);
    }
    ...
    @GetMapping("/consClienteGeografica/{Bandera}")
    public List<clienteGeograficaEntity> consultaCltGeografia(
            @PathVariable Integer Bandera) {
        return serviceclienteGeograficaService.consultaCltGeografia(Bandera);
    }

    @GetMapping("/consCUserLocalidad/{Bandera}")
    public List<ConsUserLocalidadEntity> ConsultaUserLocalidad(
            @PathVariable Integer Bandera) {
        return serviceConsUserLocalidadService.ConsultaUserLocalidad(Bandera);
    }

    @GetMapping("/consCUserLocalidadCompras/{Bandera}")
    public List<ConsUserLocalidadComprasEntity> ConsultaUserLocalidadCompras(
            @PathVariable Integer Bandera) {
        return serviceConsUserLocalidadComprasService.ConsultaUserLocalidadCompras(Bandera);
    }

    @GetMapping("/consAdPesoTotalLibras/{Bandera}/{Cd_cnctvo}")
    public List<adPesoTotalLibrasEntity> ConsultaPesoTotalLibra(
            @PathVariable Integer Bandera,
            @PathVariable Integer Cd_cnctvo) {
        return serviceadPesoTotalLibraService.ConsultaPesoTotalLibra(Bandera, Cd_cnctvo);
    }

    @GetMapping("/consAdTipoRegistro/{Bandera}")
    public List<adTipoRegistroEntity> ConsultaTipoRegistro(
            @PathVariable Integer Bandera) {
    ...
    @PostMapping("/EnvioSMSIndv")
    public String EnvioSMSIndvAA2(
            @RequestBody EnvioSMSIndvAA2Entity entidad) {
        return serviceEnvioSMSIndvAA2Service.EnvioSMSIndvAA2(entidad);
    }

    @PostMapping("/modAgroDescuento/{Bandera}")
    public String ModAgroDescuento(
            @RequestBody agroDescuentoModEntity entidad,
            @PathVariable Integer Bandera) {
        return serviceagroDescuentoModService.ModAgroDescuento(entidad, Bandera);
    }

    @GetMapping("/consagroDescuentoConsulta/{Bandera}/{Cd_cnsctvo}/{Id_sector}")
    public List<agroDescuentoConsultaEntity> CosnultaAgroDescuento(
            @PathVariable Integer Bandera,
            @PathVariable Integer Cd_cnsctvo,
            @PathVariable Integer Id_sector) {
        return serviceagroDescuentoConsultaService.CosnultaAgroDescuento(Bandera, Cd_cnsctvo, Id_sector);
    }

    @GetMapping("/consRelacionCuponesUsuario/{Bandera}/{Usucodig}")
    public List<RelacionCuponesUsuarioEntity> ConsultaRelaCuponesUser(
            @PathVariable Integer Bandera,
            @PathVariable Integer Usucodig) {
        return serviceRelacionCuponesUsuarioService.ConsultaRelaCuponesUser(Bandera, Usucodig);
    }

    @GetMapping("/consCuponesRelacionDetlle/{Bandera}/{IdCarroLider}")
    public List<CuponesRelacionDetallEntity> ConsultaCuponesRela(
            @PathVariable Integer Bandera,
            @PathVariable Integer IdCarroLider) {
